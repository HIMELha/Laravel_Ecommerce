        ...
        <section id="main" class="min-h-[98vh] py-3 px-4 mt-12 bg-[#F1F5F9]">
            <div class="max-w-[1200px] mx-auto flex flex-col gap-4">
                ...
                <div class="flex flex-col justify-start items-start">
                    <h1 class="text-[16px] text-gray-700 font-medium my-2 py-2"><i class="fa-solid fa-gears mr-2"></i>Manage
                        settings</h1>
                    <div class="flex items-center justify-start">
                        <button id="button1"
                            class="btnactive px-3 py-2 text-[15px] text-slate-700 border-b border-slate-600 ">Primary
                            Settings</button>
                        <button id="button2" class="px-3 py-2 text-[15px] text-slate-700 border-b border-slate-600 ">Front
                            End settings</button>
                        <button id="button3"
                            class="px-3 py-2 text-[15px] text-slate-700 border-b border-slate-600">Profile Settings</button>
                    </div>
                        ...
                        <div class="px-4 mt-4 flex flex-col gap-2">
                            <div class="pb-2 flex justify-between items-center gap-2 border-b border-gray-300">
                                <div class="flex flex-col gap-1">
                                    ...
                                    <p class="text-[13px] font-thin">Get Themesberg news, announcements, and product updates
                                    </p>
                                </div>
                                <div>
                            ...
                            <div class="pb-2 flex justify-between items-center gap-2 border-b border-gray-300">
                                <div class="flex flex-col gap-1">
                                    ...
                                    <p class="text-[13px] font-thin">Send an email reminding me to rate an item a week after
                                        purchase</p>
                                </div>
                                <div>
                                    <label class="relative inline-flex items-center mr-5 cursor-pointer">
                            ...
                            <div class="pb-2 flex justify-between items-center gap-2">
                                <div class="flex flex-col gap-1">
                                    ...
                                    <p class="text-[13px] font-thin">Get Themsberg news, announcements, and product updates
                                    </p>
                                </div>
                                <div>
                                    <label class="relative inline-flex items-center mr-5 cursor-pointer">
                           ...
                           @method('post') 
                            <div class="w-full flex justify-between gap-4 md:gap-10">
                                <div class="w-full flex flex-col gap-2">
                                    <label for="image" class="label"><i class="fa-solid fa-image mr-1"></i>Select site
                                        logo</label>
                                    <input type="file" name="image" class="input">

                                    <img src="{{ asset('uploads/settings/'.$settings->logo) }}" class="image" alt="">
                                </div>

                                <div class="w-full flex flex-col gap-2">
                                    <label for="title" class="label"><i
                                            class="fa-solid fa-signature mr-1"></i>Title</label>
                                    <input type="text" name="title" value="{{ $settings->title }}" placeholder="Enter title" class="input">
                                </div>
