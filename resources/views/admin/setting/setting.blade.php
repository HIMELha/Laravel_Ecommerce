            ...
            <section id="home">
                ...
                <section id="main" class="min-h-[98vh] py-3 px-4 mt-12 bg-[#F1F5F9]">
                    ...
                    <div class="flex flex-col justify-start items-start">
                        <h1 class="text-[16px] text-gray-700 font-medium my-2 py-2"><i
                                class="fa-solid fa-gears mr-2"></i>Manage
                            settings</h1>
                        <div class="flex items-center justify-start">
                            <button id="button1"
                                class="btnactive px-3 py-2 text-[15px] text-slate-700 border-b border-slate-600 ">Primary
                                Settings</button>
                            <button id="button2"
                                class="px-3 py-2 text-[15px] text-slate-700 border-b border-slate-600 ">Front
                                End settings</button>
                            <button id="button3"
                                class="px-3 py-2 text-[15px] text-slate-700 border-b border-slate-600">Profile
                                Settings</button>
                        </div>
                            ...
                            <div class="px-4 mt-4 flex flex-col gap-2">
                                <div class="pb-2 flex justify-between items-center gap-2 border-b border-gray-300">
                                    <div class="flex flex-col gap-1">
                                        ...
                                        <p class="text-[13px] font-thin">Get Themesberg news, announcements, and product
                                            updates
                                        </p>
                                    </div>
                                    <div>
                                        <label class="relative inline-flex items-center mr-5 cursor-pointer">
                                            ...
                                            <div
                                                class="w-11 h-6 bg-gray-400 rounded-full peer dark:bg-gray-700 peer-focus:ring-4 peer-focus:ring-blue-300 dark:peer-focus:ring-blue-800 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-0.5 after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-blue-600 border-blue-300">
                                            </div>
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div class="pb-2 flex justify-between items-center gap-2 border-b border-gray-300">
                                    <div class="flex flex-col gap-1">
                                        ...
                                        <p class="text-[13px] font-thin">Get important notifications about you or activity
                                            you've missed</p>
                                    </div>
                                    <div>
                                        <label class="relative inline-flex items-center mr-5 cursor-pointer">
                                ...
                                <div class="pb-2 flex justify-between items-center gap-2 border-b border-gray-300">
                                    <div class="flex flex-col gap-1">
                                        ...
                                        <p class="text-[13px] font-thin">Send me an email when someone leaves a review with
                                            their rating</p>
                                    </div>
                                    <div>
                                        <label class="relative inline-flex items-center mr-5 cursor-pointer">
                                ...
                                <div class="pb-2 flex justify-between items-center gap-2 border-b border-gray-300">
                                    <div class="flex flex-col gap-1">
                                        ...
                                        <p class="text-[13px] font-thin">Send an email reminding me to rate an item a week
                                            after
                                            purchase</p>
                                    </div>
                                    <div>
                                ...
                                <div class="pb-2 flex justify-between items-center gap-2">
                                    <div class="flex flex-col gap-1">
                                        ...
                                        <p class="text-[13px] font-thin">Get Themsberg news, announcements, and product
                                            updates
                                        </p>
                                    </div>
                                    <div>
                                ...
                                <button
                                    class="px-4 py-2 w-[200px] bg-blue-400 hover:bg-blue-500 rounded-md text-[15px] text-white">Save
                                    Changes</button>
                            </div>
                        </div>
                            ...
                            <form action="{{ route('admin.updateSettings') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="w-full flex justify-between gap-4 md:gap-10">
                                    <div class="w-full flex flex-col gap-2">
                                        <label for="image" class="label"><i class="fa-solid fa-image mr-1"></i>Select
                                            site
                                            logo</label>
                                        <input type="file" name="image" class="input">

                                        <img src="{{ asset('uploads/settings/' . $settings->logo) }}" class="image"
                                            alt="">
                                    </div>

                                    <div class="w-full flex flex-col gap-2">
                                        <label for="title" class="label"><i
                                                class="fa-solid fa-signature mr-1"></i>Title</label>
                                        <input type="text" name="title" value="{{ $settings->title }}"
                                            placeholder="Enter title" class="input">
                                    </div>

                                </div>

                                <div class="w-full flex flex-col gap-2">
                                    <label for="title" class="label"><i class="fa-regular fa-file-lines mr-1"></i>Footer
                                        description</label>
                                    <textarea type="text" name="footer_desc" class="input" placeholder="Enter footer description">{{ $settings->footer_short_desc }}</textarea>
                                </div>
...
>>>>>>> 80d99c3af56bc02a7f1fa0fd0d577fa511db1ab9
                        ...
                        <form id="page3" class="w-full px-4 py-3 content bg-white border hidden">
                            <p>Manage Profile Settings</p>
                            <form action="" class="px-4 py-3 flex flex-col gap-4">
                                <div class="w-full flex justify-between gap-4 md:gap-10">
                                    <div class="w-full flex flex-col gap-2">
                                        <label for="name" class="label"><i class="fa-regular fa-user mr-1"></i>Full
                                            Name</label>
                                        <input type="text" name="name" placeholder="Your full name"
                                            value="{{ $user->name }}" class="input">
                                    </div>
                                    <div class="w-full flex flex-col gap-2">
                                        <label for="email" class="label"><i class="fa-regular fa-envelope mr-1"></i>
                                            Email</label>
                                ...
                                <div class="w-full flex justify-between gap-4 md:gap-10 mt-4">
                                    <div class="w-full flex flex-col gap-2">
                                        <label for="number" class="label"><i
                                                class="fa-solid fa-mobile-screen mr-1"></i>Phone number</label>
                                        <input type="number" name="phone" placeholder="Phone "
                                            value="{{ $user->phone }}" class="input">
                                    </div>
                                    <div class="w-full flex flex-col gap-2">
                                        <label for="Password" class="label"><i
                                                class="fa-solid fa-location-dot mr-1"></i>Password</label>
                                        <input type="password" name="password" placeholder="User Password"
                                            value="{{ $user->password }}" class="input">
                                    </div>
                                </div>


                                <button
                                    class="px-4 mt-2 py-2 w-[200px] bg-blue-400 hover:bg-blue-500 rounded-md text-[15px] text-white">Save
                                    Changes</button>
                            </form>
                        </form>
                    </div>
            ...
            <script>
                $('#page3').submit(function(e) {
                            ...
                            << << < HEAD
                                <
                                form id = "page3"
                            class = "w-full px-4 py-3 content bg-white border content hidden" >
                            ===
                            === = <
                            form id = "page3"
                            class = "w-full px-4 py-3 content bg-white border " >
                            >>>
                            >>> > 80 d99c3af56bc02a7f1fa0fd0d577fa511db1ab9
                                <
                                p > Manage Profile Settings < /p> <
                                form action = ""
                            ...
                            label
                            for = "name"
                            class = "label" > < i class = "fa-regular fa-user mr-1" > < /i>Full Name</label >
                            <
                            input type = "text"
                            name = "name"
                            ...
                            label
                            for = "email"
                            class = "label" > < i class = "fa-regular fa-envelope mr-1" > < /i> Email</label >
                            <
                            input type = "email"
                            name = "email"
                            ...
                            << << < HEAD
                                ...
                                label
                            for = "number"
                            class = "label" > < i class = "fa-solid fa-mobile-screen mr-1" > < /i>Phone number</label >
                            <
                            input type = "number"
                            name = "phone"
                            placeholder = "Phone "
                            ...
                            label
                            for = "Password"
                            class = "label" > < i class = "fa-solid fa-location-dot mr-1" > < /i>Password</label >
                            <
                            input type = "password"
                            name = "password"
                            ...
                            <
                            button class =
                            "px-4 mt-2 py-2 w-[200px] bg-blue-400 hover:bg-blue-500 rounded-md text-[15px] text-white" >
                            Save Changes < /button> <
                                /form> <
                                /form> <
                                /div> <
